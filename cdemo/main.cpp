...
int main(int argc, const char *argv[]) {
    ...
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/周华健 - 迷途.mp3"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/周深 - 随风.ape"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/za.flac"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/pfzl.ape"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/bbb.mp4"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/张芸京-怎么哭.flac"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/杰文.mp3"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/Walking in the Cold.m4a"));
    mediaCollection->addMedia(new MediaItem("/Users/audio_test/黄致列-苦海Live.ape"));
    ...
    while (std::cin >> op) {
        switch (op) {
            case 'b': {
                MediaItem *mediaItem = mediaCollection->previous();
                if (mediaItem) {
