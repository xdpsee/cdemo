...
#define BASS_STREAM_AUTOFREE	0x40000	// automatically free the stream when it close/ends
...
#define BASS_MUSIC_POSRESET		0x8000	// close all notes when moving position
#define BASS_MUSIC_POSRESETEX	0x400000 // close all notes and reset bmp/etc when moving position
#define BASS_MUSIC_STOPBACK		0x80000	// close the music on a backwards jump effect
...
RETURN : TRUE = continue recording, FALSE = close */
